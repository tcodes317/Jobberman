...
function Comm(){
    return(
        <>
            <div className="relative px-4 py-8 bg-slate-900 text-white">
                <div className="space-y-8 my-4">
                    <h1 className="text-3xl font-bold">Advance your career with Jobberman</h1>
                    <p className="text-xl text-slate-400">Create a free account, complete your profile, and get matched with your dream job.</p>
                    <button className="flex items-center">
                        <span>Learn More</span>
                        <FaArrowRight className="ml-4"/>
                    </button>
                </div>
                <div className="xxxs:mt-14 space-y-8">
                    <div className="">
                        <div className="xxxs:mb-4 xxxs:bg-gray-800 xxxs:inline-block rounded-lg">
                        ...
                        <div>Get seen by employers</div>
                        <div className="text-slate-400">With a complete profile, your applications and profile are promoted to top employers, so you stand out.</div>
                    </div>
                    <div className="">
                        <div className="xxxs:mb-4 xxxs:bg-gray-800 xxxs:inline-block rounded-lg">
                            <svg xmlns="http://www.w3.org/2000/svg" width="32" height="32" viewBox="0 0 28 28" fill="none" class="" role="presentation" aria-hidden="true">
                        ...
                        <div>Get seen by employers</div>
                        <div className="text-slate-400">Sign up for job alerts and be first in line for the latest jobs that match your profile.</div>
                    </div>
                </div>
            </div>
        </>
