...
function Header(){
    return(
        <>
            <div className="relative flex items-center justify-between px-5 py-2 shadow">
                <div className="relative flex items-center gap-12">
                    <img src="https://www.jobberman.com/static-assets/img/ng/landscape.svg" alt="" className="lg:w-3/12 xxxs:w-7/12"/>
                ...
                <div className="flex items-center">
                    <div className="lg:hidden xxxs:block">
                        <svg x-show="!open" fill="currentColor" viewBox="0 0 20 20" class="w-6 h-6"><path fill-rule="evenodd" d="M3 5a1 1 0 011-1h12a1 1 0 110 2H4a1 1 0 01-1-1zM3 10a1 1 0 011-1h12a1 1 0 110 2H4a1 1 0 01-1-1zM9 15a1 1 0 011-1h6a1 1 0 110 2h-6a1 1 0 01-1-1z" clip-rule="evenodd"></path></svg>
                    </div>
                    <div className="items-center xxxs:hidden lg:flex">
